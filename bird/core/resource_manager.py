...
class ResourceManager:
    ...
    def load_all(self):
        ...
        print("====== 开始加载全局资源 ======")
        # 加载战斗专属背景，并强行拉伸到匹配咱们的窗口大小 (658, 370)
        bg_img = pygame.image.load("./resources/battle_bg.png").convert_alpha()
        self.images['battle_bg'] = pygame.transform.scale(bg_img, (658, 370))
        # 1. 加载通用背景
        try:
